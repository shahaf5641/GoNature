...
/**
 * This Class is the GUI controller of CardReader.fxml It handles all the JavaFx
 * nodes events.
 * 
 * In this screen, we simulate travelers entering and exiting the park using the
 * card reader.
 *
 */
public class CardReaderController implements Initializable {
    ...
    @FXML
    private TextField exitTimeTextField;
    ...
    /**
     * This method generate message base on the parameters she gets. each message is
     * added to 'messages' arrayList
     * 
