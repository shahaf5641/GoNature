...
/**
 * This Class is the GUI controller of ManageTraveler.fxml It handles all the
 * JavaFx nodes events.
 * 
 * In this screen the entrance worker makes can confirm a visit or open a window
 * to create a new casual visit.
 *
 */
public class ManageTravelerController implements Initializable {
	...
	private void loadCasualVisit() {
		try {
			...
			newStage.getIcons().add(new javafx.scene.image.Image(GoNatureFinals.APP_ICON));
	...
	private void init(ArrayList<OrderTb> orders) {
		...
		travelerIDCol
				.setCellValueFactory(new javafx.scene.control.cell.PropertyValueFactory<OrderTb, String>("travelerId"));
		orderIDCol.setCellValueFactory(new javafx.scene.control.cell.PropertyValueFactory<OrderTb, Integer>("orderId"));
		dateCol.setCellValueFactory(new javafx.scene.control.cell.PropertyValueFactory<OrderTb, String>("orderDate"));
		timeCol.setCellValueFactory(new javafx.scene.control.cell.PropertyValueFactory<OrderTb, String>("orderTime"));
		statusCol.setCellValueFactory(
				new javafx.scene.control.cell.PropertyValueFactory<OrderTb, String>("orderStatus"));
