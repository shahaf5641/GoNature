...
public class ManageTravelerController implements Initializable {
    ...
    private void init(ArrayList<OrderTb> orders) {
        ...
        travelerIDCol.setCellValueFactory(new javafx.scene.control.cell.PropertyValueFactory<OrderTb, String>("travelerId"));
        ...
        statusCol.setCellValueFactory(new javafx.scene.control.cell.PropertyValueFactory<OrderTb, String>("orderStatus"));
