...
public class ClientToServerRequest<T> implements Serializable {
	...
	public enum Request {
		IS_CONNECTED, TRAVELER_LOGIN_ID, INSERT_TO_LOGGEDIN, GET_PARK_BY_ID,
		GET_ALL_PARKS, GET_MAX_DISCOUNT, GET_PARK_BY_NAME, GET_ORDERS_BETWEEN_DATES, ADD_ORDER, 
		...
		CHANGE_ORDER_NUMBER_OF_VISITORS_BY_ID, CHANGE_ORDER_PRICE_BY_ID, GET_SOLOS_ORDERS,
