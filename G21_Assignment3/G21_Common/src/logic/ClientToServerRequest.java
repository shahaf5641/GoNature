...
public class ClientToServerRequest<T> implements Serializable {
	...
	public enum Request {
		...
		DELETE_TRAVELER, INSERT_TO_CREDITCARD, MANAGER_REQUEST, GET_MESSAGES_BY_ID, VIEW_MANAGER_REQUEST,
		GET_EMPLOYEE, GET_EMPLOYEE_PASSWORD, ADD_VISIT, UPDATE_CURRENT_VISITORS_ID,
		...
		COUNT_VISIT_GROUP_VISITORS, GET_REPORTS, GET_CANCELS,GET_CANCELSDAY, GET_NOTARRIVEDDAY, VIEW_MANAGER_DISCOUNT, CONFIRM_DISCOUNT, MANAGER_REPORT,
		ADD_REPORT_TO_DB, INSERT_TO_FULL_PARK_DATE, CHECK_WAITING_LIST, GET_SIMULATOR_TRAVELERS_IDS,
		GET_RELEVANT_ORDER_EXIT, GET_RELEVANT_ORDER_ENTRANCE, UPDATE_EXIT_TIME, GET_PENDING_AFTER_DATE_PASSED,
		...
		COUNT_VISIT_SUBS_VISITORS_WITH_DAYS, COUNT_VISIT_GROUPS_VISITORS_WITH_DAYS, GET_EMPLOYEEID, EXPORT_DATA, GET_NOTARRIVED
