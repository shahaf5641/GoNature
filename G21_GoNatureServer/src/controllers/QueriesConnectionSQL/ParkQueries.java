...
public class ParkQueries {
	...
	/**
	 * This function gets a park id and receive the relevant park from the database
	 * 
	...
	/**
	 * This function gets a park name and receive the relevant park from the
	 * database
	 * 
	...
	/**
	 * This function receive all the parks from the database
	 * 
	...
	/**
	 * This function update number of visitors in a certain park.
	 * 
	 ...
	 * 
	 * @param parameters - ArrayList containing: travelerId,parkId,entrance
	 *                   Time,estimated stay time,visitDate
	 * @return true on success, false otherwise
	 */
	...
	/**
	 * This function retrieve all the comments column from 'fullparkdate' table for
	 * a given date and park
	 * 
